...
export default class LoginView extends View {
    ...
    async render() {
        ...
        subtitle.className = 'mt-10 text-center text-xl font-bold leading-9 tracking-tight text-gray-900';
        ...
        submitButton.className = 'flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600';
    ...
    createInput(id, label, type) {
        ...
        inputElem.className = 'block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-600 sm:text-sm sm:leading-6';
