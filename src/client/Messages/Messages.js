...
export default class MessagesView extends View {
    ...
    demoMessages() {
        ...
        this.addMessage(scoob, new Date, "i eat kids", false);
        this.addMessage(spiderman,new Date, "dude what", false);
    ...
    addMessage(person, timestamp, message, fromMe) {
        ...
        messageContent.className = "bg-amber-200 h-min w-auto p-3 mx-3 rounded-md drop-shadow-lg drop-shadow-amber-500 z-0";
    ...
    initializeSendView() {
        ...
        messageArea.addEventListener("keyup", e => {
            ...
            if (e.key === "Enter") {
                console.log("enter");
                this.addMessage(this.#currUser, new Date, messageArea.value, true);
